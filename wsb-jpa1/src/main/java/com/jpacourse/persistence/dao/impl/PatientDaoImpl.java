...
public class PatientDaoImpl extends AbstractDao<PatientEntity, Long> implements PatientDao {
    ...
    public List<PatientEntity> findPatientsByGender(Gender gender) {
        return entityManager.createQuery("SELECT p FROM PatientEntity p WHERE p.gender = :gender", PatientEntity.class) // can't use 'LIKE' here because Gender is an enum
