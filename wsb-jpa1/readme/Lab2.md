...
2. Korzystajac z przykladowych insertow w pliku data.sql:
   - uzupelnij encje pacjenta, doktorow oraz wizyt danymi testowymi
...
4. Dodaj metode w PatientDao, ktora na podstawie parametrow wejsciowych: ID pacjenta, ID doktora, data wizyty, opis wizyty:
